...
export default {
  name: "setname",
  description: "Altera o nome do grupo e guarda o nome anterior.",
  commands: ["setname", "set-name", "setgroupname", "set-group-name", "mudarnome", "mudar-nome-grupo", "nomegrupo", "nome-grupo"],
