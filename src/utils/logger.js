...
export function infoLog(message) {
  console.log("\x1b[34m[RENEN BOT | INFO]\x1b[0m", message);
}

export function successLog(message) {
  console.log("\x1b[32m[RENEN BOT | SUCCESS]\x1b[0m", message);
}

export function errorLog(message) {
  console.log("\x1b[31m[RENEN BOT | ERROR]\x1b[0m", message);
}

export function warningLog(message) {
  console.log("\x1b[33m[RENEN BOT | WARNING]\x1b[0m", message);
}
